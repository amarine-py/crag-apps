...
insert into location (location_id, country_name, state_province_name, city, postal_code, location_code) values
	(1, 'UNITED STATES', 'Alabama', 'Mobile', '55555', 1),
    (2, 'UNITED STATES', 'Alaska', 'Juneau', '44444', 1),
    (3, 'UNITED STATES', 'Indiana', 'Bloomington', '46460', 1),
    (4, 'UNITED STATES', 'California', 'San Jose', '90210', 1);
...
insert into climber_profile (profile_id, profile_email, profile_description, is_public, primary_safety_attitude_name, primary_climbing_motivation_name, primary_climbing_country_name, primary_climbing_state_province_name, primary_climbing_postal_code) values
	(1, 'amarine@gmail.com', 'Profile of climber #1', 1, 'VERY_IMPORTANT', 'EXERCISE', 'UNITED STATES', 'INDIANA', '46220'),
    (2, 'user2@user2.com', 'Profile of climber #2', 1, 'IMPORTANT', 'EXERCISE', 'CANADA', 'INDIANA', '46077'),
    (3, 'moderator@moderator.com', 'Profile of climber #3', 0, 'SOMEWHAT_IMPORTANT', 'EXERCISE', 'UNITED STATES', 'INDIANA', '46020');
